...
Every interactive route follows a two-file pattern:
...
All custom colors are defined in the `@theme` block in `src/styles/global.css`:
- `text-primary`, `bg-primary`, `border-primary`, `text-primary-hover` — primary maroon `#7b163e`
